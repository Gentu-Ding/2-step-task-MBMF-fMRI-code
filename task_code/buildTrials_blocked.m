function trials = buildTrials_blocked(taskStruct, blockID, numTrials, condState, condReward, condRewContingent)
    ...
    % are rewards contingent on stimulus selected, or the outcome state where they are shown?
    trials.condContingent = repmat(condRewContingent, numTrials, 1);
